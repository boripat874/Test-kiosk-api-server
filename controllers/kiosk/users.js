...
exports.userscreate = async (req, res) => {
    ...
    const usersaddLogic = new Promise(async (resolve, reject) => {
        try {
            ...
            //ขอ Portal ID
            // await axios.get(`https://${process.env.CISCO_IP}:${process.env.CISCO_PORT}/ers/config/sponsorportal`)
            // .then( async(response) => {
                ...
                // console.log("cisco create user >>> ",`https://${process.env.CISCO_IP}:${process.env.CISCO_PORT}/ers/config/guestuser`);
